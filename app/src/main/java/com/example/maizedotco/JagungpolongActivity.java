...
public class JagungpolongActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jagungpolong);
    ...
    public void jagungpolong(View view) {
        Intent intent;
        switch (view.getId()) {
            case R.id.jagungpolong: {
                intent = new Intent(this, JagungpolongActivity.class);
                startActivity(intent);
                break;
            }
        }
