...
public class BerondongActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jagungberondong);
    ...
    public void jagungberondong(View view) {
        Intent intent;
        switch (view.getId()) {
            case R.id.jagungbrondong: {
                intent = new Intent(this, BerondongActivity.class);
                startActivity(intent);
                break;
            }
        }
